...
make ARCH=aarch64 CROSS_COMPILE=aarch64-linux-gnu- PLAT=fvp clean
make V=1 BL33=/home/kimphi01/model-work/fvp-latest-oe-uboot/fip-surgery/nt-fw.bin ARCH=aarch64 CROSS_COMPILE=aarch64-linux-gnu- PLAT=fvp all fip
